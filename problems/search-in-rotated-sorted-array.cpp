...
/*
    Complexity analysis:
    Time: O(log n), where `n` is the number of elements in the given array, as at every iteration we discard half of the elements.
    Space: O(1), since throughout the entire program we do not use any extra space.
*/

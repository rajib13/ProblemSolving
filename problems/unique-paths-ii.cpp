...
public:
    int uniquePathsWithObstacles(vector<vector<int>>& grid) {
        ...
        vector<vector<long>> dp(row, vector<long> (col, 0)); // Need this extra vector becausee one of the test cases has int overflow.
        dp[0][0] = 1; // To check the test case [[0]] type. 
